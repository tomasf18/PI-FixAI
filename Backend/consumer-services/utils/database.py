...
## Internal imports
from config import CASSANDRA_NODES, CASSANDRA_PORT, CASSANDRA_KEYSPACES, MINIO_HOST, MINIO_PORT, MINIO_ROOT_USER, MINIO_ROOT_PASSWORD, PHOTOS_BUCKET_NAME, MINIO_BUCKETS
