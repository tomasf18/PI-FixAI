...
organization_id = UUID("c62f55eb-4db2-450f-a8d4-df4d88c776b5")
organization_logo = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6uf5p_YsWjT630FCvAOcSbdk2MdAsut7Clw&s"
pwd_context = CryptContext(schemes=["bcrypt"], deprecated="auto") # default hashing algorithm
email = "cma@example.com"
...
asyncio.run(cassandra_client.execute(APP_DATA_KEYSPACE, query, (organization_id, "Câmara Municipal de Aveiro", "Portuguese of Portugal", organization_logo)))
