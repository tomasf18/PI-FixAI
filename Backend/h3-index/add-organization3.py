...
aveiro_coords = list(map(tuple, np.loadtxt("ilhavo-coords.csv", delimiter=',', dtype=float)))
...
organization_name = "Câmara Municipal de Ílhavo"
organization_language = "Portuguese of Portugal"
organization_logo = "https://recrutamento.cm-ilhavo.pt/thumbs/cmilhavo-wirerecruit/uploads/writer_file/image/3/logo_1_200_200.svg"
pwd_context = CryptContext(schemes=["bcrypt"], deprecated="auto") # default hashing algorithm
email = "cmi@example.com"
...
asyncio.run(cassandra_client.execute(APP_DATA_KEYSPACE, query, (organization_id, organization_name, organization_language, organization_logo)))
